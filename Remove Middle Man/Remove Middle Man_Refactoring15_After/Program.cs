...
namespace Solution_RemoveMiddleMan
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Manager personManager = person.GetDepartment().GetManager();
    ...
    class Person { public string Name { get; private set; } private Department _department; public Person(string name, Department department) { Name = name; _department = department; } public Department GetDepartment() { return _department; } }
}